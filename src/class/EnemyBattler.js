...
export default class EnemyBattler extends Battler {
  constructor (scene, status) {
    ...
    // name
    this.nameLabel = this.scene.add.text(0, -155, `トレント Lv ${this.lv}`, { fill: '#AAAAAA', stroke: '#222', strokeThickness: 2, fontSize: 12, fontStyle: 'bold', fontFamily: 'Ubuntu' }).setOrigin(0.5, 1)
