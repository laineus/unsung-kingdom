...
export default class ExpGauge extends Phaser.GameObjects.Container {
  constructor (scene, x, y, width, lv, exp) {
    ...
    this.label = this.scene.add.text(-width.half, -4, 'EXP', { fill: config.COLORS.soy.toColorString, stroke: config.COLORS.dark.toColorString, strokeThickness: 2, fontSize: 11, fontStyle: 'bold', fontFamily: config.FONTS.UI }).setOrigin(0, 1)
