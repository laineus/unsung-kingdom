...
export default class GameScene extends Phaser.Scene {
  ...
  create (payload) {
    ...
    this.francisca = new Friend(this, payload.x, payload.y - 1, 'francisca').setR(this.storage.state.r).setFollowDiff(8).setSpeed(230).setDisplayName(t('chara.francisca'))
    this.jaquelyn = new Friend(this, payload.x, payload.y - 2, 'jaquelyn').setR(this.storage.state.r).setFollowDiff(20).setSpeed(220).setDisplayName(t('chara.jaquelyn'))
