...
export default class MenuSetting extends Phaser.GameObjects.Container {
  constructor (scene) {
    ...
    const bgmSlider = new Slider(scene, contentX + 200, 150)
    const bgmValue = scene.add.text(contentX + 430, 141, '100%', { fill: config.COLORS.white.toColorString, fontSize: 14, fontStyle: 'bold', fontFamily: config.FONTS.TEXT })
