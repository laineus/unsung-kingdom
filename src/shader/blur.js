export default [
  ...
  'void main() {',
    ...
    // apply blurring,
    'sum += texture2D(u_texture, vec2(tc.x, tc.y)) * 0.1;',
    ...
    'sum += texture2D(u_texture, vec2(tc.x - 1.5*blur, tc.y + 1.0*blur)) * 0.025;',
    'sum += texture2D(u_texture, vec2(tc.x + 1.5*blur, tc.y + 1.0*blur)) * 0.025;',
    'sum += texture2D(u_texture, vec2(tc.x - 2.5*blur, tc.y + 0.0*blur)) * 0.025;',
    'sum += texture2D(u_texture, vec2(tc.x + 2.5*blur, tc.y + 0.0*blur)) * 0.025;',
    'sum += texture2D(u_texture, vec2(tc.x - 1.5*blur, tc.y - 1.0*blur)) * 0.025;',
    'sum += texture2D(u_texture, vec2(tc.x + 1.5*blur, tc.y - 1.0*blur)) * 0.025;',
    ...
    'sum += texture2D(u_texture, vec2(tc.x + 3.0*blur, tc.y + 0.0*blur)) * 0.025;',
    'sum += texture2D(u_texture, vec2(tc.x - 3.0*blur, tc.y + 0.0*blur)) * 0.025;',
    'sum += texture2D(u_texture, vec2(tc.x + 0.0*blur, tc.y + 3.0*blur)) * 0.025;',
    'sum += texture2D(u_texture, vec2(tc.x + 0.0*blur, tc.y - 3.0*blur)) * 0.025;',
